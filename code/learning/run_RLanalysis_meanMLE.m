...
fid_summary = fopen(fullfile(maindir,'summary_2P_meanMLE.csv'),'w');
fprintf(fid_summary,'subject,condition,psuedoR2,BIC\n');
for s = 1:length(subjects)
    ...
    for c = 1:length(conditions)
        ...
        R = result;
        fprintf(fid_summary,'%d,%s,%f,%f\n',subject,condition,R.pseudoR2,R.BIC);
        
        fid_subj = fopen(fullfile(maindir,['rpe_' num2str(subject) '_' condition '_2P_meanMLE.csv']),'w');
